...
<div className="lg:w-[328px] lg:h-[15px] lg:gap-[0px]  h-[24px] lg:mt-2 gap-[0px] " > 
  ...
  <div className=" lg:w-[238px] lg:h-[40px] lg:gap-[10px]  w-[193px] h-[40px] gap-[10px] lg:flex flex lg:justify-between  justify-between lg:items-center items-center lg:bg-transparent  sm:bg-red-600 "> 
    ...
    <p className=" hidden lg:block lg:w-[38px] lg:mr-[6px] lg:h-[19px] lg:gap-[0px] lg:font-normal lg:text-[16px] lg:leading-[19.36px] lg:text-left lg:text-[#000000] ">Filter</p>
    </div>
 <div className="lg:flex flex lg:justify-between justify-between lg:w-[140px] lg:h-[40px]  lg:pt-[8px] lg:pr-[16px] lg:pb-[8px] lg:pl-[16px] lg:gap-[8px] border rounded-md lg:bg-[#F97316] bg-[#F97316]">
